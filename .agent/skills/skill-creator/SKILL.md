...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. This skill is always used when creating or modifying any other skill.
---

# Antigravity Skill Creator

## When to use this skill
- Use this skill when generating a NEW skill (folder structure and instructions).
- Reference this logic anytime you are asked to create or update any specialized logic for the agent environment.
- Use it to ensure consistency in YAML frontmatter and folder hierarchy across all agent capabilities.
...
## Support Files
If applicable, provide content for `scripts/` or `examples/` in the response.
