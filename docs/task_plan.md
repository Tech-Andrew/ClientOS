# task_plan.md — ClientFlow B.L.A.S.T. Task Plan

---

## 🎯 North Star
Build **ClientFlow** — a self-hosted client management OS for freelancers and agencies. A single dashboard to manage clients, projects, tasks, invoices, approvals, and messaging with a polished UI and Supabase backend.
